...
class Node(object):
    def __init__(self, row, column):
        ...
        self.portalStart = False
        self.portal2Start = False
        self.portal3Start = False
        self.portal4Start = False
...
class NodeGroup(object):
    def __init__(self, level):
        ...
        self.nodeSymbols = ["+", "n", "N", "H", "S", "Y", "F", "R", "T", "U", "L"] + self.portalSymbols
    ...
    def pathToFollow(self, direction, row, col, path, grid):
        ...
        if grid[row][col] in tempSymbols:
            ...
            if grid[row][col] == "R":
                node.portalStart = True
            if grid[row][col] == "T":
                node.portal2Start = True
            if grid[row][col] == "U":
                node.portal3Start = True
            if grid[row][col] == "L":
                node.portal4Start = True
            if grid[row][col] in self.portalSymbols:
                node.portalVal = grid[row][col]
            return node
        else:
